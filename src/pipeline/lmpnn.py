...
class LogicalMPNNLayer(nn.Module):
    ...
    def forward(self, init_term_emb_dict, predicates, pred_emb_dict, inv_pred_emb_dict):
        ...
        #         continue
        #     agg_emb = sum(collect_emb_list) + init_term_emb_dict[t] * self.eps
        #     agg_emb = self.mlp(agg_emb)
